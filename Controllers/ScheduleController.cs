    ...
    public class ScheduleController : ControllerBase
    {
        ...
        public Response<object> SendAlertEmail(long ChildId)
        {
            ...
            if (todaySchedules.Any())
            {
                ...
                body = $"Reminder: Vaccination {string.Join(" ", doseDetails)} of {child.Name} is due. Please confirm your appointment. Thanks!\n " +
                       $" Dr {clinic?.Doctor?.FirstName} {clinic?.Doctor?.LastName}, {clinic?.Name} \n" + 
